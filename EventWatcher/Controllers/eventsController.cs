...
namespace EventWatcher.Controllers
{
    public class eventsController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Getevents(long id)
        {
        ...
        public async Task<IHttpActionResult> Putevents(long id, events events)
        {
        ...
        // DELETE: api/events/5
        [ResponseType(typeof(events))]
        public async Task<IHttpActionResult> Deleteevents(long id)
        {
            events events = await db.events.FindAsync(id);
            if (events == null)
            {
